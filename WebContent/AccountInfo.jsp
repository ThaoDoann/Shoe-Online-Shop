    ...
    <div class="jumbotron">
      <form class="form-signin" action="CustomerController" Method= "POST">
        ...
        <div class="input-group" style="margin-bottom:6px;">
          ...
          <input type="text" class="form-control" name="regUserName" value="<%=existingCxLogIn.getCxUserName()%>" id="userName" readonly >          
        </div>
        <!-- password -->
        <div class="input-group" style="margin-bottom:6px">
          <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
          <input type="password" class="form-control" name="regPassword" value="<%=existingCxLogIn.getCxPassword()%>" onchange="btnAble()" required><br>
        </div>
        <!-- first name -->
        <div class="input-group" style="margin-bottom:6px; width:49.5%; float:left">
          ...
          <input type="text" class="form-control" name="regFirstName" value="<%=existingCxLogIn.getCxFirstName()%>" onchange="btnAble()" required>
        </div>
        <!-- last name -->
        <div class="input-group" style="margin-bottom:6px; width:49.5%; float:right">
          <span class="input-group-addon"><i class="glyphicon glyphicon-text-background"></i></span>
          <input type="text" class="form-control" name="regLastName" value="<%=existingCxLogIn.getCxLastName()%>" onchange="btnAble()" required><br>
        </div>
        <!-- address -->
        <div class="input-group" style="margin-bottom:6px">
          <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
          <input type="text" class="form-control" name="regAddress" value="<%=existingCxLogIn.getCxAddress()%>" onchange="btnAble()" required><br>
        </div>
        <!-- city -->
        <div class="input-group" style="margin-bottom:6px; width:49.5%; float:left">
          <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
          <input type="text" class="form-control" name="regCity" value="<%=existingCxLogIn.getCxCity()%>" onchange="btnAble()" required><br>
        </div>
        <!-- postal code -->
        <div class="input-group" style="margin-bottom:6px; width:49.5%; float:right">
          <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
          <input type="text" class="form-control" name="regPostalCode" value="<%=existingCxLogIn.getCxPostalCode()%>" onchange="btnAble()" maxlength="6"  required><br>
        </div>
        <br><br><br><br>
